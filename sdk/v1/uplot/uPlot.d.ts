...
declare namespace uPlot {
    ...
    export namespace Cursor {
        ...
        export interface Hover {
            ...
            prox?:
                | number
                | null
                | ((self: uPlot, seriesIdx: number, closestIdx: number, xValue: number) => number | null); // null/Infinity
    ...
    export namespace Series {
        ...
        export type BarsPathBuilderRadius =
            | number
            | BarsPathBuilderRadii
        ...
        export type Value =
            | string
            | ((self: uPlot, rawValue: number, seriesIdx: number, idx: number | null) => string | number);
